...
typedef struct {
    const size_t        __size__;   // done
    const char          *__name__;  // done
    ctor_t              __ctor__;   // done
    dtor_t              __dtor__;   // done
    to_string_t         __str__;    // done
    binary_operator_t   __add__;    // done
    binary_operator_t   __sub__;    // done
